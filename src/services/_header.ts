import { FAST_GPT_ACCESS_CODE, OPENAI_API_KEY_HEADER_KEY, OPENAI_END_POINT } from '@/const/fetch';
...
export const createHeaderWithOpenAI = (header?: HeadersInit): HeadersInit => {
  ...
  return {
    ...header,
    [FAST_GPT_ACCESS_CODE]: keyVaultsConfigSelectors.password(useUserStore.getState()),
