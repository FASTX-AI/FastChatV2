...
1. Stop and delete the currently running FastChat container (assuming the name of the FastChat container is `lobe-chat`):
...
3. Redeploy the FastChat container using the newly pulled image:
...
>
> Don't worry, all of LobeChat's chat history is stored in your local browser. Therefore, when you redeploy FastChat using Docker, your chat history will not be lost.
