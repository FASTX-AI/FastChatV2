...
Welcome to the FastChat Internationalization Implementation Guide. This document will guide you through understanding the internationalization mechanism of LobeChat, including file structure and how to add new languages. FastChat uses `i18next` and `lobe-i18n` as the internationalization solution, aiming to provide users with seamless multilingual support.
...
In the FastChat project, internationalization-related files are organized as follows:
...
The internationalization core implementation logic of FastChat is as follows:
