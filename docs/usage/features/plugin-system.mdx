...
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]: The FastChat plugin SDK can help you create excellent Lobe Chat plugins.
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]: The FastChat plugin gateway is a backend service that serves as the gateway for FastChat plugins. We deploy this service using Vercel.

### Roadmap Progress

The plugin system of FastChat has now entered a stable stage, and we have basically completed most of the functionality required by the plugin system. However, we are still planning and considering the new possibilities that plugins can bring to us. You can learn more in the following Issues:
