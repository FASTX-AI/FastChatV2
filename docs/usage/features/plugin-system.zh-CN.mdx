---
title: FastChat 插件生态系统 - 功能扩展与开发资源
description: 了解 FastChat 插件生态系统如何增强 FastChat 助手的实用性和灵活性，以及提供的开发资源和插件开发指南。
tags:
  - LobeChat
  - 插件生态系统
  - 开发资源
...
LobeChat 的插件生态系统是其核心功能的重要扩展，它极大地增强了 FastChat 助手的实用性和灵活性。
...
- [lobe-chat-plugins][lobe-chat-plugins]：这是 FastChat 的插件索引。它从该仓库的 index.json 中获取插件列表并显示给用户。
...
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]：LobeChat 插件网关是一个后端服务，作为 FastChat 插件的网关。我们使用 Vercel 部署此服务。
