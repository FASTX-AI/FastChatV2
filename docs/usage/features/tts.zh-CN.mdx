---
title: FastChat 支持 TTS & STT 语音会话
description: FastChat 支持文字转语音（TTS）和语音转文字（STT）技术，提供高品质声音选项，个性化交流体验。了解更多关于 Lobe TTS 工具包。
tags:
  - TTS
  - STT
  - 语音会话
...
<Callout type={'info'}>
  我们在实现 FastChat 的 TTS 功能过程中，发现市面上并没有一款很好的 TTS
