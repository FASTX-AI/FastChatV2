...
Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, FastChat supports integration with Ollama, meaning you can easily enhance your application by using the language models provided by Ollama in LobeChat.
...
<Image
  alt="FastChat guide your to install Ollama model"
  height="460"
...
<Callout type={'info'}>
  ...
  FastChat to meet integration needs with Ollama.
</Callout>
