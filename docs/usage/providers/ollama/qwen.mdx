...
Now, through the integration of FastChat and [Ollama](https://ollama.com/), you can easily use Qwen in LobeChat. This document will guide you on how to use the local deployment version of Qwen in LobeChat:
...
In the FastChat conversation page, open the model selection panel, and then select the Qwen model.
