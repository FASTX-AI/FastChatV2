---
title: Enhance Your FastChat Assistant with Plugins
description: >-
  Learn how to expand your FastChat assistant's capabilities by enabling and
...
Watch the following video to quickly get started with using FastChat plugins:
