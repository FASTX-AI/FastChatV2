---
title: Deploy FastChat with Vercel
description: >-
  Learn how to deploy FastChat on Vercel with ease. Follow the provided steps to
...
# Deploy FastChat with Vercel

If you want to deploy FastChat on Vercel, you can follow the steps below:
