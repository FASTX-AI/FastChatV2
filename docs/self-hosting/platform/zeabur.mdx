---
title: Deploy FastChat on Zeabur
description: >-
  Learn how to deploy FastChat on Zeabur with ease. Follow the provided steps to
...
# Deploy FastChat with Zeabur

If you want to deploy FastChat on Zeabur, you can follow the steps below:
