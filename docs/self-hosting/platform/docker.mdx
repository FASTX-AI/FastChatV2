---
title: Deploy FastChat with Docker
description: >-
  Learn how to deploy the FastChat service using Docker, including installation
...
We provide a [Docker image][docker-release-link] for you to deploy the FastChat service on your private device.
...
Use the following command to start the FastChat service with one click:
