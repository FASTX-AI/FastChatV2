---
title: Deploy FastChat with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy FastChat on Netlify with detailed instructions on forking
...
# Deploy FastChat with Netlify

If you want to deploy FastChat on Netlify, you can follow these steps:

## Deploy FastChat with Netlify

<Steps>
  ### Fork the FastChat Repository

Click the Fork button to fork the FastChat repository to your GitHub account.
...
Next, select the FastChat project:

<Image
  alt={'Select the FastChat github project'}
  height={228}
  inStep
...
<Image
  alt={'Configure FastChat site name'}
  height={712}
  inStep
...
<Image
  alt={'Add FastChat site environment variables'}
  height={537}
  inStep
...
Upon entering the deployment details, you will see the following interface, indicating that your FastChat is currently being deployed. Simply wait for the deployment to complete.
...
If your Deploy Log in the interface looks like the following, it means your FastChat has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your FastChat site.

  <Image alt={'Access Your FastChat Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
