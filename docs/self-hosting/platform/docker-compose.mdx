---
title: Deploy FastChat with Docker Compose
description: >-
  Learn how to deploy the FastChat service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the FastChat service on your private device.
