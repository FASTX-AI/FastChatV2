...
description: >-
  Learn how to configure ZITADEL Authentication Service for FastChat deployment,
...
<Callout type={'important'}>
  ...
  - Replace `http(s)://your-domain` with the actual URL that FastChat is deployed to.
</Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use FastChat using existing
