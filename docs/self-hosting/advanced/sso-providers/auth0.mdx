...
description: >-
  Learn how to configure Auth0 Identity Verification Service for FastChat for
...
<Callout>
  After successful deployment, users will be able to authenticate and use FastChat using the users
  configured in Auth0.
</Callout>
...
<Callout type={'warning'}>
  ...
  FastChat being abused by external users.
</Callout>
