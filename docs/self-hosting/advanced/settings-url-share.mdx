...
LobeChat support import settings from external URL to quickly set up FastChat configuration.
...
<Callout type={'warning'}>
    FastChat does not verify the correctness of the settings parameters in the URL, nor provide encryption or decryption methods. Please use with caution.
</Callout>
