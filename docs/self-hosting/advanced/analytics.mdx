---
title: Integrating Data Analytics Services in FastChat for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in FastChat to
...
To better help analyze the usage of FastChat users, we have integrated several free/open-source data analytics services in FastChat for collecting user usage data, which you can enable as needed.
