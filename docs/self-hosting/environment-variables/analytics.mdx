...
description: >-
  ...
  Analytics, PostHog Analytics, and Umami Analytics in FastChat for data
...
We have integrated several free/open-source data analytics services in FastChat for collecting user usage data. Here are environment variables that you can use.
